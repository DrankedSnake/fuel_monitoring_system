...
use crate::api::{profiles::domain::TankProfile, densities::domain::DensityCoefficient};
...
impl Tank {
    ...
    pub fn update(&mut self, tank_profile: &TankProfile, density_coefficient_in_vacuum: &DensityCoefficient, density_coefficient_in_air: &DensityCoefficient){
        self.previous_volume = self.current_volume;
        self.previous_mass = self.current_mass;
        self.current_volume = Self::round_f64(
            tank_profile.volume * density_coefficient_in_vacuum.coefficient
        );
